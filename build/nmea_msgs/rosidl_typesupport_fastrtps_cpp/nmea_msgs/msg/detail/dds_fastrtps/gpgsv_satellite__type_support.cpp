...
#include "nmea_msgs/msg/detail/gpgsv_satellite__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nmea_msgs::msg::GpgsvSatellite & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nmea_msgs::msg::GpgsvSatellite & ros_message)
{
  // Member: prn
  cdr >> ros_message.prn;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nmea_msgs::msg::GpgsvSatellite;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nmea_msgs::msg::GpgsvSatellite *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nmea_msgs::msg::GpgsvSatellite *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GpgsvSatellite__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nmea_msgs::msg::GpgsvSatellite *>(
...
static size_t _GpgsvSatellite__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GpgsvSatellite(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GpgsvSatellite__callbacks = {
  "nmea_msgs::msg",
  "GpgsvSatellite",
...
static rosidl_message_type_support_t _GpgsvSatellite__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GpgsvSatellite__callbacks,
...
{
  return &nmea_msgs::msg::typesupport_fastrtps_cpp::_GpgsvSatellite__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nmea_msgs, msg, GpgsvSatellite)() {
  return &nmea_msgs::msg::typesupport_fastrtps_cpp::_GpgsvSatellite__handle;
}
